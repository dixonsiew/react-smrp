...
import { MaritalStatusService } from '../api'
import { AppConstant } from '../../../../constants'

const MaritalStatusListing = () => {
  ...
  const goto = (path) => {
    saveUIState()
    navigate(`/main/setup/marital-status/${path}`, { replace: false })
  }
...
export default MaritalStatusListing
