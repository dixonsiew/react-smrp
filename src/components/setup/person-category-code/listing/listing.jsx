...
import { PersonCategoryCodeService } from '../api'
import { AppConstant } from '../../../../constants'

const PersonCategoryCodeListing = () => {
  ...
  const goto = (path) => {
    saveUIState()
    navigate(`/main/setup/person-category-code/${path}`, { replace: false })
  }
...
export default PersonCategoryCodeListing
